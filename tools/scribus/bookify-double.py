...
imagepath = "/data/projects/riverstudies/danube/montagen/NT/2006-12-21--edfu"
imagepath = "/data/projects/slitscan/malisca/montage-data/NT/2013-02-18--amazon-LNK"
imagepath = "/data/projects/slitscan/malisca/montage-data/NT/2011-12-13--varanasi-LNK"
imagepath = "/data/projects/slitscan/malisca/montage-data/NT/2012-01-08--guwahati-LNK"
imagepath = "/data/projects/slitscan/malisca/montage-data/NT/2011-06-17--linz-krems-LNK"
#imagepath = "/data/projects/slitscan/malisca/montage-data/NT/2011-12-16--chunar-banares-LNK"
#imagepath = "/data/projects/A1/tiles/2011-04-27--westautobahn-II/512x512/"
...
tile_h = tile_w / 4
tile_h = tile_w
tile_h = tile_w * (1063.0/1772.0)

num_rows = math.floor(page_h / (tile_h + tile_h * 2 * margin_fac))
margin_h = (page_h - ( num_rows * tile_h + (num_rows-1) * 2 * tile_h * margin_fac )) / 2

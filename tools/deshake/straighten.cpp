...
const int MO_big=25;
const int RY_big=15;
int YO1_big[MO_big]={-24,-16,-12,-10,-8,-6,-4,-3,-2,-1,-1,+0,+0,+1,+1,+2,+2,+3,+4,+6,+8,+10,+12,+16,+24};//ydelta1
int YO2_big[MO_big]={+24,+16,+12,+10,+8,+6,+4,+3,+2,+2,+1,+1,+0,+0,-1,-1,-2,-3,-4,-6,-8,-10,-12,-16,-24};//ydelta2

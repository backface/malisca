...
wget -q -O /dev/null "http://$CAM/setparams.php?TRIG=0"
wget -q -O /dev/null "http://$CAM/camvc.php?set=0/gg:1.0/ggb:1.0/"
wget -q -O /dev/null "http://$CAM/setparams.php?WOI_HEIGHT=96&WOI_TOP=924&QUALITY=95"
...
wget -q -O /dev/null "http://$CAM/setparams.php?PF_HEIGHT=2"
wget -q -O /dev/null "http://$CAM/setparams.php?QUALITY=95"

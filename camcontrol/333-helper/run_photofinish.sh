...
#init_1='/admin-bin/ccam.cgi?opt=vhcxyu+!-&dh=2&dv=2&ww=4000&wh=4000&bh=1&bv=1&iq=70&sens=2&bit=8&gam=64&pxl=10&csb=200&csr=200&e=100&wl=0&wt=0&q=100'
...
DATE=$(date --utc +%Y%m%d)
CROP_H=`expr $HEIGHT - 2`
let TOP=(1536-$HEIGHT)/2
echo CROP: $CROP_H px
echo TOP: $TOP px

INIT_STRING="$CAM_URL/admin-bin/ccam.cgi?opt=vhcxmuy+!$URL&pfh=$PFH&ww=$WIDTH&wh=$HEIGHT&wl=0&wt=$TOP&fps=$FPS&dh=1&dv=1&q=100"
